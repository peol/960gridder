 ...
 *
 * Changelog:
 * - Menu and grid should now be visible over flash content also.
 *   The flash content are although being restarted for this to work.
 *   An variable has been added, fixFlash, set this to false to remove
 *   this feature.
 */
...
function Grid() {
	...
	window.gridSettingsDef = {
		urlBase: 'http://960gridder.keep.se/releases/1.2.2/',
		gColor: '#EEEEEE',
		gColumns: 12,
		gOpacity: 0.35,
		gWidth: 10,
	...
	this.createGrid = function () {
		...
		jQuery('embed').each(function () {
			if (window.gridSettings.fixFlash) {
			...
			// Instead of .clone(), which does not work on IE on <embed>, we do this...
